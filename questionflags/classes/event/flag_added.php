...
class flag_added extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('event_flag_added', 'local_questionflags');
    }
    ...
    public function get_description() {
        ...
        return "The user with id '{$this->relateduserid}' added a '{$color}' flag to question id '{$qid}'.";
    }
