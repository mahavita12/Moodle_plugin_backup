...
$background = optional_param('background', 0, PARAM_BOOL); // Optional async mode for admin action.
...
// Synchronous generation (default) for admin action so it works even when cron isn't running.
try {
