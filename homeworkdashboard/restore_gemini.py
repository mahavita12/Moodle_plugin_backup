...
construct_prompt = r'''    private function construct_prompt(string $student_name, array $new_activities, array $revision_activities, int $completed_new, int $total_new, int $completed_revision, int $total_revision, string $lang): string {
...
with open('/home/master/applications/srfshmcmyg/public_html/local/homeworkdashboard/classes/gemini_helper.php', 'w') as f:
    f.write(full_content)

print('Successfully restored gemini_helper.php')
